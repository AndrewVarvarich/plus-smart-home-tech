...
@Component
public class ScenarioAddedEventProcessor extends BaseHubEventProcessor<ScenarioAddedEventAvro> {

    private final ScenarioService service;

    public ScenarioAddedEventProcessor(final ScenarioService service) {
